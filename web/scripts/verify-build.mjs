...
assert.match(home, /Your Codex pet/);
assert.match(home, /existing Codex pet/);
assert.match(home, /menu bar/);
assert.match(home, /codex-pet-bar\/releases\/latest/);
assert.match(home, /v0\.1\.2/);
assert.match(home, /demo previews v0\.2/);
assert.match(home, /open at login/);
assert.match(home, /You choose whether to enable it/);
